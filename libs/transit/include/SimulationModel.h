...
class SimulationModel {
  ...
  */
  ...
  /**
   * @brief updates the notifications bar
   **/
  void updateNotifications();

  /**
   * @brief Finds an entity of a specified type
   * @param type String specifying the type of entity to find
   * @returns IEntity* (of the specified type)
  */
  IEntity* findEntity(std::string type);

  /**
   * @brief Update the displayed battery percentage
   * @param percent Double to display
  */
